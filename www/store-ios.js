...
/// ```js
///     store.register({
///       id: "com.biolabs.purchase.consumable1",
///       alias: "100 coins",
...
///     // or
///     var p = store.get("com.biolabs.purchase.consumable1");
/// ```
///
...
///     function show() {
///         render();
///         store.when("com.biolabs.test1").updated(render);
///     }
///
///     function render() {
///
///         // Get the product from the pool.
///         var product = store.get("com.biolabs.test1");
///
///         if (!product) {
///             $el.html("");
///         }
...
/// ```js
/// store.when("com.biolabs.subcription").updated(function(product) {
///     if (product.owned)
///         app.subscriberMode();
///     else
///         app.guestMode();
...
//
/// ```js
///     var product = store.get("com.biolabs.product1");
/// ```
///
...
store.when = function(query, once, callback) {
    ...
    if (typeof once === 'function') {
        ...
        ///
        /// ```js
        /// store.when("com.biolabs.inapp1", "approved", function(product) { ... });
        /// ```
        ///
        var action = once;
...
///  - `"order com.biolabs.inapp1"` - the `id` of a registered [`product`](#product)
///    - equivalent to just `"com.biolabs.inapp1"`
...
/// #### example
///
///     store.products.byId["com.biolabs.inapp1"]
store.products.byId = {};
